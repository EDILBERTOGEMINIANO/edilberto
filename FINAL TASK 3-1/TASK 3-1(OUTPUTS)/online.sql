CREATE TABLE online_courses.courses (
...
INSERT INTO online_courses.courses (course_name, category, enrollment_limit, students_enrolled)
VALUES
...
SELECT * FROM online_course.courses 
